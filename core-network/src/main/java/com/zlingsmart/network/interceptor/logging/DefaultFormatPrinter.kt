package com.zlingsmart.network.interceptor.logging

import android.text.TextUtils
import com.zlingsmart.network.CharacterHandler.Companion.jsonFormat
import com.zlingsmart.network.CharacterHandler.Companion.xmlFormat
import com.zlingsmart.network.interceptor.logging.LogInterceptor.Companion.isJson
import com.zlingsmart.network.interceptor.logging.LogInterceptor.Companion.isXml
        ...
        private fun logLines(
            ...
            for (line in lines) {
                ...
                for (i in 0..lineLength / maxLongSize) {
                    ...
                    Timber.tag(TAG).d(DEFAULT_LINE + line.substring(start, end))
                }
            }
        }
